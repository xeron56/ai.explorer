...
export function LogoIcon(p: IconProps) { return (<svg viewBox="0 0 32 32" width={28} height={28} fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" {...p}><path d="M12 7 5 16l7 9" /><path d="m20 7 7 9-7 9" /><path d="m18 5-4 22" /></svg>); }
